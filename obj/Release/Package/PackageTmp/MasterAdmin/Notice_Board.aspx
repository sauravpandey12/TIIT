<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin/main.Master" AutoEventWireup="true" CodeBehind="Notice_Board.aspx.cs" Inherits="TIIT.MasterAdmin.Notice_Board" %>
            ...
            <div class="row">
                <div class="col-lg-4 colmd-4 col-sm-12 col-xs-12">
                    <div class="content-wraper">
                        <h2 class="title">Upload Notice Board</h2>
                        <div class="txtbx-sec">
                            ...
                            <div class="txtbx-wraper">
                                ...
                                <span style="color: #e42323; float: right;">Max size (500kb)</span>
                            </div>
                            <div class="row">
                 ...
                 <asp:Label ID="lbl_filepath3" style="opacity:0;" runat="server" Text=""></asp:Label> 
                            ...
                            <div class="grid-wraper">
                                <div class="table-responsive" style="overflow: auto">
                                    <table class="table table-striped table-advance table-hover">
                                        <tr>
                                            <td>
                                                <asp:GridView ID="grd_notice_board" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="true" OnPageIndexChanging="grd_notice_board_PageIndexChanging" AllowPaging="True" Font-Bold="False" class="table table-striped table-advance table-hover" Style="margin-top: 0; width: 100%; overflow: scroll" OnSelectedIndexChanged="grd_notice_board_SelectedIndexChanged">
                                                    <RowStyle />
                                                    <Columns>
